...
import { CssBaseline, ThemeProvider, createTheme, Alert, Snackbar, Button, ButtonGroup, Box } from '@mui/material';
...
const CitySelector = () => {
  ...
  return (
    ...
    >
      <ButtonGroup variant="contained" aria-label="Şehir seçimi">
        ...
        <>
          ...
          >
            <Alert onClose={handleCloseAlert} severity="info" sx={{ width: '100%' }}>
              Gerçek veri yüklenemedi. Demo veriler ile heatmap oluşturuldu! {selectedCity === 'ankara' ? 'Ankara' : 'Aydın'} için rastgele oluşturulmuş veri gösteriliyor.
            </Alert>
          </Snackbar>
        </>
      )}
